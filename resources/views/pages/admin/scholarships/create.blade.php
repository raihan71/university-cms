...
<div class="container-fluid mb-4">
  ...
  <h1 class="mt-4">Buat Beasiswa Baru</h1>
  <ol class="breadcrumb mb-4">
      <li class="breadcrumb-item"><a href="{{ route('portal-admin.scholarships.index') }}">Daftar Beasiswa</a></li>
      <li class="breadcrumb-item active">Buat Beasiswa Baru</li>
  </ol>
  <div class="card">
    <div class="card-body">
      <form action="{{ route('portal-admin.scholarships.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="form-group">
              <label for="name">Nama</label>
              <input type="text" class="form-control" placeholder="Contoh: Beasiswa A" id="name" name="name" required>
          </div>
          <div class="form-group">
              <label for="description">Deskripsi</label>
              <textarea class="form-control" placeholder="Contoh: Deskripsi Beasiswa A" id="description" name="description" rows="3" required></textarea>
          </div>
          <div class="card mb-3">
